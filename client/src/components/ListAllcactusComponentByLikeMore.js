...
const ListAllcactusComponentByLikeMore=(props)=>{
    ...
    console.log(word)
    const fetchData=()=>{
        axios.get(`${process.env.REACT_APP_API}/cactusByLikeMoreToLess/${props.match.params.word}/${props.match.params.type}`)
        .then(response=>{
    ...
    function myFuntionSearch(element,words){
        ...
        if(words == "" && type == "" ){
            history.push('/cactusAllByLikeMore/-/-')
            window.location.reload()
        }else if(words == "" && type == "-"){
            history.push('/cactusAllByLikeMore/-/-')
            window.location.reload()
        }else if(words == ""){
            history.push(`/cactusAllByLikeMore/-/${type}`)
            window.location.reload()
        }else if(type == "" ||type == "-"){
            history.push(`/cactusAllByLikeMore/${words}/-`)
            window.location.reload()
        }else{
            history.push(`/cactusAllByLikeMore/${words}/${type}`)
            window.location.reload()
        }
...
export default ListAllcactusComponentByLikeMore;